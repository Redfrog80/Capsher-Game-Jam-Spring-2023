...
controller.addEventSpawn(1, 1, 100, (1, 6), enemy.Assault, "enemy")
controller.addEventSpawn(2, 2, 100, (1, 6), enemy.Kamikaze, "enemy")
controller.addEventSpawn(3, 3, 100, (1, 6), enemy.Juggernaut, "enemy")
controller.addEventSpawn(4, 4, 100, (1, 6), enemy.Sentinel, "enemy")
